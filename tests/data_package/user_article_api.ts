...
type UserResultPick = 'id' | 'username' | 'password' | 'phoneNum' | 'articles'
...
export interface ArticleUpdateInput {
    title?: string
    content?: string | null
    author?: (UserUpdateInput | Link | UnLink)[]
    author_ids?: string[]
}

type ArticleSortOrder = 'title' | '-title' | 'content' | '-content'

type ArticleResultPick = 'id' | 'title' | 'content' | 'author' | 'author_ids'

interface ArticleAuthorInclude {
    author?: UserListQuery
}

type ArticleInclude = ArticleAuthorInclude
